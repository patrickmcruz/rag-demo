...
class AppConfig:
    ...
    def load(cls, env: Optional[dict] = None) -> "AppConfig":
        ...
        return cls(
            ...
            embedding_model=env.get("EMBEDDING_MODEL", "all-MiniLM-L12-v2"),
            chunk_size=int(env.get("CHUNK_SIZE", 350)),
            chunk_overlap=int(env.get("CHUNK_OVERLAP", 75)),
            top_k_documents=int(env.get("TOP_K_DOCUMENTS", 10)),
